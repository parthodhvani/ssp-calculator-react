...
import { t as createMiddleware } from "./createMiddleware-CDiXQFMX.mjs";
import { n as toResponse, t as H3Event } from "../_libs/h3-v2+rou3+srvx.mjs";
import { n as cu, r as lu, t as Ou } from "../_libs/seroval.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-a4pO4vcq.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D7RxHHoP.mjs"),
		import("./start-tREQa8v7.mjs"),
