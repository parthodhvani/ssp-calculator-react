...
import { T as BookOpen, c as Newspaper, d as Mail, h as FileSearch, i as ShieldCheck, s as PanelLeft, t as X, w as Calculator } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-D7RxHHoP.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-HZLYYX6Z.css";
...
function AppSidebar() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Sidebar, {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarHeader, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "grid h-8 w-8 shrink-0 place-items-center rounded-md bg-sidebar-primary font-serif text-sm font-bold text-sidebar-primary-foreground",
						children: "R"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "font-serif text-lg leading-none tracking-tight group-data-[collapsible=icon]:hidden",
						children: "Recura"
					})]
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarContent, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarGroup, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupLabel, { children: "Tools" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupContent, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenu, { children: primary.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenuItem, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenuButton, {
				asChild: true,
			...
			}) }, item.url)) }) })] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarGroup, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupLabel, { children: "Learn" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupContent, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenu, { children: secondary.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenuItem, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenuButton, {
				asChild: true,
				isActive: isActive(item.url),
				tooltip: item.title,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarFooter, {
				className: "border-t border-sidebar-border/60 px-3 py-3 text-[11px] leading-relaxed text-sidebar-foreground/70 group-data-[collapsible=icon]:hidden",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "font-mono uppercase tracking-wider text-sidebar-foreground/50",
						children: "Ref"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Dutch Civil Code Art. 7:629" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Minimum wage · July 2026" })
				]
			})
		]
	});
...
var Route$7 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Estimate continued pay during illness under Dutch law (Art. 7:629), check eligibility, and audit your own sick-leave policy."
			},
			{
				name: "author",
				content: "Recura"
			...
			{
				property: "og:title",
				content: "Recura — Netherlands sick leave calculator"
			},
			{
				property: "og:description",
				content: "A real euro estimate of your continued pay during illness, with the rules explained."
			},
			{
				property: "og:type",
				content: "website"
...
function RootComponent() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(QueryClientProvider, {
		client: queryClient,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppSidebar, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
					className: "sticky top-0 z-30 flex h-14 items-center gap-3 border-b border-border/70 bg-background/80 px-4 backdrop-blur",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarTrigger, { className: "-ml-1" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "hidden text-xs font-mono uppercase tracking-[0.14em] text-muted-foreground sm:block",
							children: "Dutch Civil Code · Art. 7:629"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "ml-auto",
...
var $$splitComponentImporter$5 = () => import("./routes-Da7_rkMD.mjs");
var Route$6 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
var $$splitComponentImporter$4 = () => import("./blog-2aC1ofWv.mjs");
var Route$5 = createFileRoute("/blog")({
	head: () => ({ meta: [{ title: "Blog — Recura" }, {
		name: "description",
		content: "Notes on Dutch sick-leave law, CAOs and payroll edge cases."
	}] }),
	component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
var $$splitComponentImporter$3 = () => import("./contact-C1PjdQip.mjs");
var Route$4 = createFileRoute("/contact")({
	head: () => ({ meta: [{ title: "Contact — Recura" }, {
		name: "description",
		content: "Get in touch with the Recura team."
	}] }),
	component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
var $$splitComponentImporter$2 = () => import("./eligibility-DMcMoey6.mjs");
var Route$3 = createFileRoute("/eligibility")({
	head: () => ({ meta: [{ title: "Eligibility — Recura" }, {
		name: "description",
		content: "Check whether you're covered by Dutch statutory sick-pay rules (Art. 7:629)."
	}] }),
	component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
var $$splitComponentImporter$1 = () => import("./policy-analyser-DtxIfkFE.mjs");
var Route$2 = createFileRoute("/policy-analyser")({
	head: () => ({ meta: [{ title: "Policy Analyser — Recura" }, {
		name: "description",
		content: "Upload your sick-leave policy, contract or CAO excerpt and check it against Dutch statutory rules."
	}] }),
	component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
var $$splitComponentImporter = () => import("./rules-DEv4NxN2.mjs");
var Route$1 = createFileRoute("/rules")({
	head: () => ({ meta: [{ title: "Rules — Recura" }, {
		name: "description",
		content: "The Dutch statutory rules Recura applies: Art. 7:629, waiting days, and the 104-week limit."
	}] }),
...
var rootRouteChildren = {
	...
	EligibilityRoute: Route$3.update({
		id: "/eligibility",
		path: "/eligibility",
		getParentRoute: () => Route$7
	}),
	PolicyAnalyserRoute: Route$2.update({
		id: "/policy-analyser",
