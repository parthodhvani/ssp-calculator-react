...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Recura — Netherlands sick leave, calculated properly" },
      {
        name: "description",
        content:
          "Estimate continued pay during illness under Dutch law (Art. 7:629), check eligibility, and audit your own sick-leave policy.",
      },
      { name: "author", content: "Recura" },
      { property: "og:title", content: "Recura — Netherlands sick leave calculator" },
      {
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Libre+Baskerville:ital,wght@0,400;0,700;1,400&family=IBM+Plex+Sans:wght@400;500;600;700&family=IBM+Plex+Mono:wght@400;500&display=swap",
      },
    ],
  }),
