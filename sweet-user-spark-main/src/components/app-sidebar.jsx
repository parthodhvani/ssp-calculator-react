...
import { Calculator, ShieldCheck, FileSearch, BookOpen, Newspaper, Mail } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
  ...
  return (
    <Sidebar collapsible="icon">
      ...
      <SidebarFooter className="border-t border-sidebar-border/60 px-3 py-3 text-[11px] leading-relaxed text-sidebar-foreground/70 group-data-[collapsible=icon]:hidden">
        <p className="font-mono uppercase tracking-wider text-sidebar-foreground/50">Ref</p>
